...
//		FileHandler.copy(sourcefile1, destinationfile1);
		...
		File dest1 = new File("./screens/name.pbg");
		...
		Rectangle rect = new Rectangle(screenSize3);
		
		BufferedImage createScreenCapture = robt.createScreenCapture(rect);
		
		ImageIO.write(Source1, "png", dest);
